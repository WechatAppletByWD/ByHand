...
public class fileUpload extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response){
        System.out.println(new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(new Date())+"FileUpload接口收到"+request.getRemoteAddr()+"的请求");
       ...
       // String path = request.getServletContext().getRealPath("/");
        ...
        try{
           ...
           TaskImage taskImage= TaskImageService.upload(path,fii);
            if(TaskImageService.updateTaskImage(taskImage)){
                TaskImage list=taskImage;
